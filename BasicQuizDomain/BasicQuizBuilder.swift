...
public struct BasicQuizBuilder {
    ...
    private init(multipleAnswerQuestion: String, options: NonEmptyOptions, answer: NonEmptyOptions) throws {
    ...
    private func adding(question: Question<String>, options: [String], answer: [String]) throws -> BasicQuizBuilder {
        ...
        return BasicQuizBuilder(questions: questions + [question], options: newOptions, correctAnswers: correctAnswers + [(question, answer)])
    }
}
