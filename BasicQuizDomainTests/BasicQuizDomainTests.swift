//
//  BasicQuizDomainTests.swift
//  BasicQuizDomainTests
//
...
class BasicQuizDomainTests: XCTestCase {
    ...
    func test_initWithSingleAnswerQuuestion_invalidData_throws() throws {
    ...
    func test_addSingleAnswerQuuestion_invalidData_throws() throws {
        ...
        let params: [(q: String, o: NonEmptyOptions, a: String, e: BasicQuizBuilder.AddingError)] = [
            ...
            ("q3", ["o3","o4","o5"], "o6", .missingAnswerInOptions(answer: ["o6"], options: ["o3","o4","o5"]))
        ]
    ...
    private func assertEqual(_ a1: [(Question<String>, [String])], _ a2: [(Question<String>, [String])], file: StaticString = #file, line: UInt = #line) {
        XCTAssert(a1.elementsEqual(a2, by: ==), "\(a1) is not equal to \(a2)", file: file, line: line)
    }
